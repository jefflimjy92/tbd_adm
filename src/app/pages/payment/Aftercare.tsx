...
const MOCK_AFTERCARE: AftercareRecord[] = [
  ...
  },
  {
    ...
    commissionRate: '20%',
    commissionAmount: '5,960,000',
    commissionSettled: true,
    followUpDate: '2026-03-27',
    status: 'completed',
    satisfaction: 'excellent',
    notes: '빠른 처리에 매우 만족, 가족 소개 의향',
  },
  {
    id: 'AC-007',
  ...
  },
  {
    ...
    commissionRate: '18%',
    commissionAmount: '7,650,000',
    commissionSettled: false,
    followUpDate: '2026-04-15',
    status: 'in_progress',
    satisfaction: 'good',
    notes: '지급 완료 후 추가 보험 상담 요청',
  },
  {
    id: 'AC-009',
  ...
  },
  {
    ...
    status: 'completed',
    satisfaction: 'good',
    notes: '직장 동료 2명 소개 완료, 소개 리워드 지급',
  },
];
