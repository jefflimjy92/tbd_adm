...
const MOCK_REFERRALS: ReferralRecord[] = [
  ...
  },
  {
    id: 'REF-006',
    referrerName: '이미영',
    referrerRequestId: 'R-2026-003',
    referrerOwner: '김영업',
    referredName: '이재훈',
    referredPhone: '010-****-6677',
    referralDate: '2026-03-31',
    relation: 'sibling',
    status: 'contacted',
    newRequestId: 'R-2026-022',
    assignedOwner: '김영업',
    sameOwnerApplied: true,
    rewardGiven: false,
    notes: '남동생, 직장보험 검토 중',
  ...
  },
  {
    id: 'REF-007',
    referrerName: '박진호',
    referrerRequestId: 'R-2026-005',
    referrerOwner: '이영업',
    referredName: '박수현',
    referredPhone: '010-****-9988',
  ...
  },
  {
    id: 'REF-008',
    referrerName: '최수진',
    referrerRequestId: 'R-2026-007',
    referrerOwner: '최영업',
    referredName: '최우성',
    referredPhone: '010-****-4321',
    referralDate: '2026-04-02',
    relation: 'child',
    status: 'converted',
    newRequestId: 'R-2026-025',
    assignedOwner: '최영업',
    sameOwnerApplied: true,
    rewardGiven: true,
    notes: '성인 자녀, 암보험 계약 완료',
    currentStep: 'R10',
  },
  {
    id: 'REF-009',
    referrerName: '정하늘',
    referrerRequestId: 'R-2026-009',
    referrerOwner: '박영업',
    referredName: '정민아',
    referredPhone: '010-****-5566',
    referralDate: '2026-04-03',
    relation: 'colleague',
    status: 'contacted',
    newRequestId: 'R-2026-027',
    assignedOwner: '박영업',
    sameOwnerApplied: true,
    rewardGiven: false,
    notes: '직장 동료, 3년환급 관심',
  ...
  },
  {
    ...
    referrerOwner: '박영업',
    referredName: '김나영',
    referredPhone: '010-****-7744',
    referralDate: '2026-04-04',
    relation: 'friend',
    status: 'pending',
    newRequestId: null,
    assignedOwner: null,
  ...
  },
  {
    ...
    referrerOwner: '최영업',
    referredName: '오지혜',
    referredPhone: '010-****-8866',
    referralDate: '2026-04-06',
    relation: 'sibling',
    status: 'contacted',
    newRequestId: 'R-2026-031',
    assignedOwner: '최영업',
    sameOwnerApplied: true,
    rewardGiven: false,
    notes: '여동생, 다음 주 미팅 예정',
    currentStep: 'R4',
  },
  {
    id: 'REF-013',
    ...
    referrerOwner: '김영업',
    referredName: '정태경',
    referredPhone: '010-****-2211',
    referralDate: '2026-04-07',
    relation: 'colleague',
    status: 'converted',
    newRequestId: 'R-2026-033',
    assignedOwner: '김영업',
    sameOwnerApplied: true,
    rewardGiven: true,
    notes: '직장 동료, 간편청구 계약 완료',
    currentStep: 'R12',
  },
  {
    id: 'REF-014',
  ...
  },
  {
    ...
    referrerOwner: '이영업',
    referredName: '류정호',
    referredPhone: '010-****-5511',
    referralDate: '2026-04-09',
    relation: 'other',
    status: 'contacted',
    newRequestId: 'R-2026-038',
    assignedOwner: '이영업',
    sameOwnerApplied: true,
    rewardGiven: false,
    notes: '지인의 지인, 종신보험 관심',
    currentStep: 'R3',
  },
];
